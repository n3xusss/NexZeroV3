        ...
        <div className="flex flex-col items-center gap-5 text-center lg:items-end lg:text-right">
          ...
          <div>
            ...
            <div className="flex justify-center gap-2.5 lg:justify-end">
              <SocialIcon href="https://www.instagram.com/nexus.estin/" label="Instagram">
              ...
              <SocialIcon href="https://github.com/n3xusss" label="GitHub">
              ...
              <SocialIcon href="https://discord.gg/Kcn6ZpZ7yB" label="Discord">
              ...
              <SocialIcon href="https://www.facebook.com/profile.php?id=61551649420493" label="Facebook">
